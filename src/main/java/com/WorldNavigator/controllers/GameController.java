...
public class GameController {
  ...
  @ResponseBody
  public ResponseEntity<DefaultReply> joinGame(@RequestBody String jsonRequest)
      throws JsonProcessingException {
    JoinRequest request = JSONDecode.decodeJsonString(jsonRequest, JoinRequest.class);
    DefaultReply reply = gameService.joinGame(request.getUsername(), request.getWorldName());
    return new ResponseEntity(reply, HttpStatus.OK);
  }

  @RequestMapping(value = "/api/game/unjoin", method = RequestMethod.POST)
  @ResponseBody
  public ResponseEntity<DefaultReply> unJoinGame(@RequestBody String jsonRequest)
      throws JsonProcessingException {
    JoinRequest request = JSONDecode.decodeJsonString(jsonRequest, JoinRequest.class);
    DefaultReply reply = gameService.unJoinGame(request.getUsername(), request.getWorldName());
    return new ResponseEntity(reply, HttpStatus.OK);
  }

  @RequestMapping(value = "/api/game/create", method = RequestMethod.POST)
  @ResponseBody
  public ResponseEntity<DefaultReply> createGame(@RequestBody String jsonRequest)
      throws IOException {
    CreateRequest request = JSONDecode.decodeJsonString(jsonRequest, CreateRequest.class);
    DefaultReply reply =
        gameService.createNewGame(
            request.getUsername(), request.getWorldName(), request.getMapFile());
    return new ResponseEntity(reply, HttpStatus.OK);
  }

  @RequestMapping(value = "/api/game/command", method = RequestMethod.POST)
  @ResponseBody
  public ResponseEntity<DefaultReply> executeCommand(@RequestBody String jsonRequest)
      throws JsonProcessingException {
  ...
  @ResponseBody
  public ResponseEntity<DefaultReply> startGame(@RequestBody String jsonRequest)
      throws JsonProcessingException {
    JoinRequest request = JSONDecode.decodeJsonString(jsonRequest, JoinRequest.class);
  ...
  @ResponseBody
  public ResponseEntity<ListGamesReply> getAvailableGames(@RequestBody String jsonRequest)
      throws JsonProcessingException {
    ...
    reply = gameService.getAvailableGames();
    return new ResponseEntity(reply, HttpStatus.OK);
  }

  @RequestMapping(value = "/api/game/map", method = RequestMethod.POST)
  @ResponseBody
  public ResponseEntity<MapFilesReply> getMapFiles(@RequestBody String jsonRequest)
      throws IOException {
    LoginRequest request = JSONDecode.decodeJsonString(jsonRequest, LoginRequest.class);
  ...
  @ResponseBody
  public ResponseEntity<GameReply> quitGame(@RequestBody String jsonRequest)
      throws JsonProcessingException {
    JoinRequest request = JSONDecode.decodeJsonString(jsonRequest, JoinRequest.class);
